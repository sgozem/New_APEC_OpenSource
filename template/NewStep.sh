...
#
# Defining the redox state of the chromophore and type of tail to 
# generate the proper key file to compute the ESPF charges
#
option=0
...
#
# continuing generating teh key file
#
