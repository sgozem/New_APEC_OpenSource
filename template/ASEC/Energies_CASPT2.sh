...
#
# reading information from infos file
#
...
#
# Collecting data to compute the CASPT2 energies
#
...
if [[ $actspace == "custom" ]]; then
   ...
   sed -i "s|nActEl=10 0 0|nActEl=$actelec 0 0|" CASPT2_ipea_025/${Project}_CASPT2_0.input
   sed -i "s|Ras2=10|Ras2=$actorb|" CASPT2_ipea_025/${Project}_CASPT2_0.input
   sed -i "s|Inactive=62|Inactive=$inactorb|" CASPT2_ipea_025/${Project}_CASPT2_0.input
fi
