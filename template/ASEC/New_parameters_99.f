      ...
      character line40*40,line49*49,line11*11,vdw*57,line13*13,
     &          atomtype*40,line6*6,line2*2,line10*10,mass*10 
...
CCCCCCCCCCCCCCCC
      ...
      do i=1,numindx2
         read(2,'(A,i4,3x,i2,A,A,A)')line11,ind2,ind3,line40,line2,
     &   line10
         atomtype(ind2)=line40
         mass(ind2)=line10
         indx3(ind2)=ind3
      enddo
...
c different charge
      ...
      do i=1,icont
         ...
         if (kkk.eq.0) then
            ...
            if (kk.eq.0) then
              write(5,'(A11,i4,2x,i3,A,i2,A,4x,i1)')
     &              'atom       ',newindx2,indx3(indx2(ind1))+100,
     &              atomtype(indx2(ind1)),99,mass(indx2(ind1)),0
      ...
      if (ifxx.gt.0) then
         do i=1,ifxx
            if (itype(i).eq.0) then
               write(5,'(A11,i4,2x,i3,A,i2,A,4x,i1)')'atom       ',
     &         ifixnewindx2,indx3(indx2(ifxxall(i))),
     &         atomtype(indx2(ifxxall(i))),99,mass(indx2(ifxxall(i))),0
               write(8,'(A11,i4,14x,f9.6)')'charge     ',
